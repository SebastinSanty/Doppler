...
sdf2 = df.drop(df[df.freq < 610].index)
sdf2 = sdf2.drop(sdf[sdf.freq > 630].index)
...
sdf2 = df.drop(df[df.freq < 390].index)
sdf2 = sdf2.drop(sdf[sdf.freq > 410].index)
sdf2 = sdf2.drop(sdf[sdf.amp == 0].index)
...
sdf2 = df.drop(df[df.freq < 910].index)
sdf2 = sdf2.drop(sdf[sdf.freq > 925].index)
sdf2 = sdf2.drop(sdf[sdf.amp == 0].index)
...
sdf2 = df.drop(df[df.freq < 985].index)
sdf2 = sdf2.drop(sdf[sdf.freq > 1000].index)
sdf2 = sdf2.drop(sdf[sdf.amp == 0].index)
